...
st.header("Tell Us About Your Computer")
computer_type = st.selectbox(
    "Select the type of computer:",
    ["Desktop", "Laptop", "Tablet", "Smartphone", "Thin Client"]
)
make = st.text_input("Enter the make (e.g., Dell, HP, Apple, Samsung):")
model = st.text_input("Enter the model (e.g., Inspiron 15, MacBook Air, Galaxy Tab):")

st.write(f"You selected a **{computer_type}**: {make} {model}.")
